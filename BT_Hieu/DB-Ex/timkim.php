...
<body>
    ...
    <form action="timkim.php" method="POST" id="myForm">
        ...
        <table align='center' width='max-content' border='1' cellpadding='2' cellspacing='2' style='border-collapse:collapse'>
            ...
            //redirect to first
            echo '<a onclick="submit()" href = "  timkim.php?page=' . 1 . '"> << </a>&nbsp';
            //redirect to previous
            if ($page > 1) {
                echo '<a onclick="submit()" href = "  timkim.php?page=' . $page - 1 . '"> < </a>&nbsp';
            ...
            for ($index = 1; $index <= $number_of_page; $index++) {
                ...
                echo '<a onclick="submit()" href = "  ketqua.php?page=' . $index . '&search='.@$search.' ">' . $index . '&nbsp</a>';
            }
            //redirect to next
            if ($page < $number_of_page) {
                echo '&nbsp<a onclick="submit()" href = " timkim.php?page=' . $page + 1 . '"> > </a>';
            } else echo '<span> &nbsp> </span>';
            //redirect to last
            echo '&nbsp<a onclick="submit()" href = " timkim.php?page=' . 1 . '"> >> </a>';
            echo '</div>';
            echo '</td></tr>';
