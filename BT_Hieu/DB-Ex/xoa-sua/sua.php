...
if (isset($_POST['submit'])) {
    ...
    SET Ten_khach_hang="' . $_POST["tenKH"] . '", 
        Phai="' . $_POST["gioiTinh"] . '" ,
...
<body>
    ...
    <form action="" method="POST">
        ...
        <table>
            ...
            if (mysqli_num_rows($result) <> 0) {
                ...
                while ($rows = mysqli_fetch_row($result)) {
                    ...
                    echo "<tr bgcolor='$color'>
                        ...
                        <td colspan='2'>" .
                        '<input type="text" name="' . 'tenKH' . '"  value="' . $rows[1] . '" >'
                        . "</td></tr>";
                    if ($rows[2] == 0) {
                        echo '<tr bgcolor=' . $color . '>
                        <td>Gioi tinh: </td>
                        <td><input type="radio" name="gioiTinh" value="0" checked id="">Nam</td>
                        <td><input type="radio" name="gioiTinh" value="1" id="">Nu</td>
                        </tr>';
                    } else if ($rows[2] == 1) {
                        echo '<tr bgcolor=' . $color . '>
                        <td>Gioi tinh: </td>
                        <td><input type="radio" name="gioiTinh" value="0" id="">Nam</td>
                        <td><input type="radio" name="gioiTinh" value="1" checked id="">Nu</td>
                        </tr>';
                    }
                    ...
                    echo "<tr bgcolor='$color'>
                        <td>Dia chi: </td>
                        <td colspan='2'>" .
                        '<input type="text" name="' . 'diaChi' . '"  value="' . $rows[3] . '" >'
                        . "</td></tr>";
                    echo "<tr bgcolor='$color'>
                        <td>So dien thoai: </td>
                        <td colspan='2'>" .
            ...
            ?>
            <tr bgcolor='#ccd5ae'>
                <td colspan="3"><input type="submit" class="submit" value="Sua" name="submit"></td>
            </tr>
        </table>
