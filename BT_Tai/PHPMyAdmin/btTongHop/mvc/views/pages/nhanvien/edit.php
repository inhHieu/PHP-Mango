    ...
    <div class="container-fluid p-0 ">
        <div class="row ">
            <div class="col-lg-12">
                <div class="checkform">
                    <div class="content">
                        <h3 style="text-align: center;" class="title">CHỈNH SỬA THÔNG TIN NHÂN VIÊN</h3>
                        ...
                        <form action="NhanVien/Save/<?php echo $data["nv"]['manv'] ?>" method="post" enctype="multipart/form-data">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group1">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="honv" value="<?php echo $data["nv"]['honv'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group1">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="tennv" value="<?php echo $data["nv"]['tennv'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group1">
                                    ...
                                    <div class="col-md-7">
                                        <div class="checkbox" style="width: 475px;">
                                            Nam <input type="radio" name="gioitinh" id="" value="1" <?php if ($data["nv"]['gioitinh'] == 1) echo "checked"; ?>> &nbsp;
                                            Nữ <input type="radio" name="gioitinh" id="" value="0" <?php if ($data["nv"]['gioitinh'] == 0) echo "checked"; ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group1">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="ngaysinh" value="<?php echo $data["nv"]['ngaysinh'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group1">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="diachi" value="<?php echo $data["nv"]['diachi'] ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-7">
                                        <select name="phongban" id="" class="shipper">
                                            ...
                                            foreach ($data['pb'] as $pb) {
                                                if ($data["nv"]["maphong"] == $pb['maphong']) {
                                                    $s = "selected";
                                                } else {
                                                    $s = "";
                                                }
                                                echo '<option ' . $s . ' value="' . $pb['maphong'] . '" class = "form-control">' . $pb['tenphong'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        <select name="chucvu" id="" class="shipper">
                                            ...
                                            foreach ($data['cv'] as $cv) {
                                                if ($data["nv"]["maloai"] == $cv['maloai']) {
                                                    $s = "selected";
                                                } else {
                                                    $s = "";
                                                }
                                                echo '<option ' . $s . ' value="' . $cv['maloai'] . '" class = "form-control">' . $cv['tenloai'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
